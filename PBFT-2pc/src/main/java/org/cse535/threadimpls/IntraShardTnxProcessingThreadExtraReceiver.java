...
public class IntraShardTnxProcessingThreadExtraReceiver extends Thread {
    ...
    public IntraShardTnxProcessingThreadExtraReceiver(Node node, TransactionInputConfig tnxInput, AtomicBoolean isCrossShardSuccess) {
